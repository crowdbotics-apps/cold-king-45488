"""
Django settings for cold_king_45488 project.
...
ROOT_URLCONF = 'cold_king_45488.urls'
...
WSGI_APPLICATION = 'cold_king_45488.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_king_45488 API",
    "DESCRIPTION": "API documentation for cold_king_45488 App",
    "VERSION": "v1",
}
